...
INPUT_VIDEO_PATH = '/Users/arnavps/Desktop/New DL project data to transfer to external disk/caged pyrallis inference data/original videos/GH010182.MP4'
OUTPUT_DIR = '/Users/arnavps/Desktop/New DL project data to transfer to external disk/caged pyrallis inference data/original frames'

# How many frames to save starting from START_FRAME
NUM_FRAMES = 5000               # Set to the number of frames you want
